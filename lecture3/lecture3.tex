...
Lets $S(z,v)$ denote the probability that information set with vulnerability $v$ will be breached. 
...
\begin{itemize}
    ...
    \item What does this model miss?
    \item 
    \item This is a ``one round'' (aka ``one shot'') game. 
    \begin{itemize}
